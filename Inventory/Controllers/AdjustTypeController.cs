...
namespace Inventory.Controllers
{
    public class AdjustTypeController : MyController
    {
        ...
        [HttpGet]
        public JsonResult SaveAction(string adjustTypeName, string shortName, bool isIncrease)
        {
            Entities.PrcInsertAdjustType(adjustTypeName, shortName, isIncrease);
            return Json("", JsonRequestBehavior.AllowGet);
        }

        [HttpGet]
        public JsonResult EditAction(string adjustTypeName, string shortName, bool isIncrease)
        {
            Entities.PrcUpdateAdjustType(editAdjustTypeID, adjustTypeName, shortName, isIncrease);
            return Json("", JsonRequestBehavior.AllowGet);
        }
