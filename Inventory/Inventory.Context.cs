...
namespace Inventory
{
    ...
    public partial class InventoryDBEntities : DbContext
    {
        ...
        public virtual DbSet<T_MasterSaleOrder> T_MasterSaleOrder { get; set; }
        public virtual DbSet<T_MasterSaleReturn> T_MasterSaleReturn { get; set; }
        public virtual DbSet<T_TranSale> T_TranSale { get; set; }
        public virtual DbSet<T_TranSaleOrder> T_TranSaleOrder { get; set; }
        ...
        public virtual int PrcInsertAdjustType(string adjustTypeName, string shortName, Nullable<bool> isIncrease)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcInsertAdjustType", adjustTypeNameParameter, shortNameParameter, isIncreaseParameter);
        }
        ...
        public virtual int PrcInsertCustomer(string customerName, string code, string phone, string email, string address, string contact, Nullable<int> townshipID, Nullable<int> branchID, Nullable<bool> isCredit)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcInsertCustomer", customerNameParameter, codeParameter, phoneParameter, emailParameter, addressParameter, contactParameter, townshipIDParameter, branchIDParameter, isCreditParameter);
        }
        ...
        public virtual int PrcInsertSupplier(string supplierName, string code, string phone, string email, string address, string contact, Nullable<int> townshipID, Nullable<int> branchID, Nullable<bool> isCredit)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcInsertSupplier", supplierNameParameter, codeParameter, phoneParameter, emailParameter, addressParameter, contactParameter, townshipIDParameter, branchIDParameter, isCreditParameter);
        }
    
        public virtual int PrcInsertTownship(string townshipName, string code)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcInsertTownship", townshipNameParameter, codeParameter);
        }
        ...
        public virtual int PrcUpdateAdjustType(Nullable<int> adjustTypeID, string adjustTypeName, string shortName, Nullable<bool> isIncrease)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcUpdateAdjustType", adjustTypeIDParameter, adjustTypeNameParameter, shortNameParameter, isIncreaseParameter);
        }
        ...
        public virtual int PrcUpdateCustomer(Nullable<int> customerID, string customerName, string code, string phone, string email, string address, string contact, Nullable<int> townshipID, Nullable<int> branchID, Nullable<bool> isCredit)
        {
            var customerIDParameter = customerID.HasValue ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcUpdateCustomer", customerIDParameter, customerNameParameter, codeParameter, phoneParameter, emailParameter, addressParameter, contactParameter, townshipIDParameter, branchIDParameter, isCreditParameter);
        }
        ...
        public virtual int PrcUpdateSupplier(Nullable<int> supplierID, string supplierName, string code, string phone, string email, string address, string contact, Nullable<int> townshipID, Nullable<int> branchID, Nullable<bool> isCredit)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcUpdateSupplier", supplierIDParameter, supplierNameParameter, codeParameter, phoneParameter, emailParameter, addressParameter, contactParameter, townshipIDParameter, branchIDParameter, isCreditParameter);
        }
    
        public virtual int PrcUpdateTownship(Nullable<int> townshipID, string townshipName, string code)
        {
            var townshipIDParameter = townshipID.HasValue ?
                new ObjectParameter("TownshipID", townshipID) :
                new ObjectParameter("TownshipID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PrcUpdateTownship", townshipIDParameter, townshipNameParameter, codeParameter);
        }
